...
<div class="menu">
	<ul id="leftmenu">
		...
		<li><a href="<?php echo createUrl('admin','main');?>" target="main" class="">首页</a></li>
		<li><a href="<?php echo createUrl('admin','user_list');?>" target="main" class="">网站主管理</a></li>
		<li><a href="<?php echo createUrl('admin','advertiser_list');?>" target="main" class="">广告主管理</a></li>
		<li><a href="<?php echo createUrl('admin','advert_list');?>" target="main" class="">广告管理</a></li>
